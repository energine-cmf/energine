...
<xsl:stylesheet
    ...
    <xsl:template name="stylesheets">
        <link href="{$STATIC_URL}stylesheets/{$FOLDER}/common.css" rel="stylesheet" type="text/css" media="all" />
		<link href="{$STATIC_URL}stylesheets/{$FOLDER}/screen.css" rel="stylesheet" type="text/css" media="Screen, projection" />
