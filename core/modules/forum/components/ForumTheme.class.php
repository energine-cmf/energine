...
//            'comment_id' =>     FieldDescription::FIELD_TYPE_INT,
    ...
    protected function remove() {
        ...
        $this->dbh->modify(QAL::DELETE, 'forum_theme_comment', null, array('target_id' => $themeId));
    ...
    private function isCanEditTheme($themeId) {
        ...
        if (!$themeId or !E()->getAUser()->isAuthenticated())
            return false;
