...
INSERT INTO `share_sitemap_translation` (`smap_id`, `lang_id`, `smap_name`, `smap_title`, `smap_description_rtf`, `smap_html_title`, `smap_meta_keywords`, `smap_meta_description`, `smap_is_disabled`) VALUES
(80, 1, 'Главная страница', NULL, NULL, NULL, NULL, NULL, 0),
(330, 1, 'Войти', NULL, NULL, 'Вход', NULL, NULL, 0),
(80, 2, 'Головна сторінка', NULL, NULL, NULL, NULL, NULL, 0),
(330, 2, 'Увійти', NULL, NULL, 'Вхід', NULL, NULL, 0);


INSERT INTO `share_uploads` (`upl_id`, `upl_pid`, `upl_childs_count`, `upl_path`, `upl_filename`, `upl_name`, `upl_title`, `upl_description`, `upl_publication_date`, `upl_data`, `upl_views`, `upl_internal_type`, `upl_mime_type`, `upl_is_mp4`, `upl_is_webm`, `upl_is_flv`, `upl_width`, `upl_height`, `upl_is_ready`, `upl_duration`, `upl_is_active`) VALUES
(1, NULL, 0, 'uploads/public', 'public', 'public', 'Локальный репозиторий', NULL, NULL, NULL, 0, 'repo', 'repo/local', 0, 0, 0, NULL, NULL, 1, NULL, 1);
...
(1, NULL, NULL, 'demo@energine.org', '123-45-67', '89e495e7941cf9e40e6980d14a16bf023ccd4c91', 1, 'Admin', NULL, NULL, NULL, NULL, 'Admins');
