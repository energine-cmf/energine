...
--
-- Структура таблицы `apps_branding`
--
...
--
-- Структура таблицы `apps_feedback_recipient`
--
...
--
-- Структура таблицы `apps_feedback_recipient_translation`
--
...
--
-- Структура таблицы `apps_news_comment`
--
...
--
-- Структура таблицы `apps_vote_question`
--
...
--
-- Структура таблицы `apps_vote_question_translation`
--
...
--
-- Структура таблицы `apps_vote_translation`
--
...
--
-- Структура таблицы `form_5_field_5_multi`
--
...
--
-- Структура таблицы `form_5_field_5_multi_values`
--
...
--
-- Структура таблицы `form_5_field_5_multi_values_translation`
--
...
--
-- Структура таблицы `form_5_field_6`
--
...
--
-- Структура таблицы `form_5_field_6_translation`
--
...
--
-- Структура таблицы `share_sitemap_comment`
--
...
--
-- Ограничения внешнего ключа таблицы `apps_feedback`
--
...
--
-- Ограничения внешнего ключа таблицы `apps_feedback_recipient_translation`
--
...
--
-- Ограничения внешнего ключа таблицы `apps_news_comment`
--
...
--
-- Ограничения внешнего ключа таблицы `apps_vote_question`
--
...
--
-- Ограничения внешнего ключа таблицы `apps_vote_question_translation`
--
...
--
-- Ограничения внешнего ключа таблицы `apps_vote_translation`
--
...
--
-- Ограничения внешнего ключа таблицы `form_5`
--
ALTER TABLE `form_5`
...
--
-- Ограничения внешнего ключа таблицы `form_5_field_5_multi`
--
...
--
-- Ограничения внешнего ключа таблицы `form_5_field_5_multi_values_translation`
--
...
--
-- Ограничения внешнего ключа таблицы `form_5_field_6_translation`
--
...
--
-- Ограничения внешнего ключа таблицы `share_domain2site`
--
...
--
-- Ограничения внешнего ключа таблицы `share_sitemap_comment`
--
...
--
-- Ограничения внешнего ключа таблицы `share_uploads`
--
