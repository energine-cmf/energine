...
<xsl:stylesheet 
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='email']">
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='phone']">
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='integer']">
    ...
    <!-- числовое поле (float) -->
    <xsl:template match="field[ancestor::component[@type='form']][@type='float']">
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='password']">
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='boolean']">
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='video']">
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='image']">
        <div class="image">
    ...
    <!-- поле типа file -->
    <xsl:template match="field[ancestor::component[@type='form']][@type='file']">
    ...
    <!-- поле типа pfile -->
    <xsl:template match="field[ancestor::component[@type='form']][@type='pfile']">
        <div class="image">
    ...
    <!-- поле типа prfile -->
    <xsl:template match="field[ancestor::component[@type='form']][@type='prfile']">
        <div class="image">
            <img alt="" border="0" id="{generate-id(.)}_preview">
                <xsl:if test="@is_image">
                    <xsl:attribute name="style">display:hidden;</xsl:attribute>
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='select']">
        <select id="{@name}">
            <xsl:attribute name="name">
                <xsl:choose>
                    <xsl:when test="@tableName"><xsl:value-of select="@tableName" />[<xsl:value-of select="@name" />]</xsl:when>
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='multi']">
    ...
    <!-- текстовое поле (text) -->
    <xsl:template match="field[ancestor::component[@type='form']][@type='text']">
        <textarea>
            <xsl:call-template name="FORM_ELEMENT_ATTRIBUTES"/>
        </textarea>
    </xsl:template>    
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='htmlblock']">
    ...
    <xsl:template match="field[ancestor::component[@type='form']][@type='datetime']">
    ...
    <!-- поле для даты (date) -->
    <xsl:template match="field[ancestor::component[@type='form']][@type='date']">
        <input>
            <xsl:call-template name="FORM_ELEMENT_ATTRIBUTES"/>
            <xsl:attribute name="type">hidden</xsl:attribute>
        </input>
