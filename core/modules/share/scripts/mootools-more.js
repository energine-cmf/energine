...
}},this);return this;},run:function(){var a=arguments;this.each(function(c,b){if($type(c)=="function"){c.run(a);}});}});String.implement({parseQueryString:function(){var b=this.split(/[&;]/),a={};
